...
//usage runDemo imageProcessing SeqEdge2 resultsFile jpgFileName
...
if (args.size() == 0){
    ...
    outFileName = "DSC_7610_4096_SeqEdge2.jpg"
    inFile = "./$inFileName"
    outFile = "./$outFileName"
}
else {
    ...
    inFileName = args[1]
    outFileName = inFileName + "_Seq2_K2"
...
System.gc()
print "Edge2 Seq, $nodes, $inFileName, "
...
image.greyScale([0])
//edge detect
image.convolutionGreyScale([0, kernel2, 1, 0])
